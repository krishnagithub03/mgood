...
// //               Everything your organization needs to build a healthier, more productive workforce with cutting-edge healthcare technology and personalized wellness programs.
// //             </p>
// //           </div>
...
// //                 Take the first step towards comprehensive employee healthcare. Our team will contact you within 24 hours.
// //               </p>
// //             </div>
...
// //                         onChange={handleChange}
// //                         className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
// //                         placeholder="Current provider name or 'None'"
// //                       />
// //                     </div>

// //                     <div>
// //                       <label htmlFor="specificNeeds" className="block text-sm font-medium text-gray-700 mb-2">
// //                         Specific Healthcare Needs or Requirements
// //                       </label>
// //                       <textarea
// //                         id="specificNeeds"
// //                         name="specificNeeds"
...
// //                         rows="4"
// //                         className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
// //                         placeholder="Tell us about any specific healthcare needs, concerns, or requirements for your organization..."
// //                       />
// //                     </div>
...
// //                         Ready to revolutionize your employee healthcare? Our experts are standing by to help you create a customized wellness program.
// //                       </p>
// //                     </div>
...
// //                           <p className="text-blue-100">corporate@mgood.health</p>
// //                         </div>
// //                       </div>
...
// //                           <p className="text-blue-100">123 Healthcare Plaza, Delhi NCR</p>
// //                         </div>
// //                       </div>
// //                     </div>
...
// //                         <p><span className="font-medium text-white">Eye Care:</span> NEEL EYE HOSPITAL</p>
// //                         <p><span className="font-medium text-white">Pharmacy:</span> AVA Pharma Network</p>
// //                         <p><span className="font-medium text-white">Diagnostics:</span> Apollo Diagnostics</p>
// //                         <p><span className="font-medium text-white">Specialists:</span> Max Healthcare Group</p>
// //                       </div>
// //                     </div>
// //                   </div>
// //                 </div>
...
// // --- Marquee Component ---
// // No changes needed here, just needs the tailwind.config.js to be correct.
// const Marquee = ({
//   className,
//   reverse = false,
//   pauseOnHover = false,
...
//       >
//         <div className="flex flex-row items-center gap-2">
//           <img className="rounded-full" style={{ width: '80px', height: '80px' }} alt="" src={img} />
//           <div className="flex flex-col">
//             <figcaption className="text-sm font-medium dark:text-white">
//               {name}
//             </figcaption>
...
//       {/* Marquee Section - This will now work */}
//       <section className="py-12 bg-gray-50 dark:bg-background">
//         <div className="relative flex w-full flex-col items-center justify-center overflow-hidden">
//        <h2 className='text-5xl font-bold text-blue-600 mb-4'>Our Onboarded Corporates</h2>
//           <Marquee pauseOnHover className="[--duration:20s]">
//             {reviews.map((review) => (
...
//               </h3>
//               <p className="text-blue-100 text-lg mb-8">
//                 Join the list of companies that have already revolutionized their employee wellness programs with MGood.
//               </p>
//               <div className="flex flex-col sm:flex-row gap-4 justify-center">
//                 <a
...
//             <div className="bg-white rounded-3xl shadow-2xl overflow-hidden">
//               <div className="grid lg:grid-cols-2">
//                 {/* Form - FIX: Wrapped in a <form> tag */}
//                 <div className="p-8 lg:p-12">
...
//                       <h3 className="text-2xl font-bold mb-4">Get in Touch</h3>
//                       <p className="text-blue-100 mb-8">
//                         Ready to revolutionize your employee healthcare? Our experts are standing by to help you create a customized MGood Program.
//                       </p>
//                     </div>
...
//                         <div>
//                           <p className="font-semibold">Call Us</p>
//                           <p className="text-blue-100">+91-8923894358</p>
//                         </div>
//                       </div>
...
//                         <div>
//                           <p className="font-semibold">Email Us</p>
//                           <p className="text-blue-100">info@mgood.org</p>
//                         </div>
//                       </div>
...
//                         <div>
//                           <p className="font-semibold">Visit Us</p>
//                           <p className="text-blue-100">73/71 Chagan Pura kotwali Road, Mathura</p>
//                         </div>
//                       </div>
//                     </div>
...
//                       <h4 className="font-semibold mb-4">Our Trusted Partners</h4>
//                       <div className="space-y-2 text-sm text-blue-100">
//                         <p><span className="font-medium text-white">Specialist Doctors</span> MGood Super Speciality Network</p>
//                         <p><span className="font-medium text-white">Pharmacy:</span> AVA Pharma Network & Safe Meds</p>
//                         <p><span className="font-medium text-white">Pathology:</span> Thyrocare / Max Healthcare / Sarvodaya</p>
//                         <p><span className="font-medium text-white">Health program MIS Analysis:</span> In House Team of Experts</p>
//                       </div>
//                     </div>
//                   </div>
//                 </div>
