...
const CustomPlan = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      description: "Seamless integration with existing insurance plans and direct billing arrangements to minimize administrative overhead."
    },
    {
      icon: <Heart className="w-8 h-8 text-red-600" />,
      title: "24/7 Health Support",
      description: "Round-the-clock teleconsultation services and emergency health support for all your employees and their families."
    },
    {
      icon: <Building className="w-8 h-8 text-purple-600" />,
      title: "On-site Health Camps",
      description: "Regular health checkup camps at your workplace including eye exams, blood tests, and specialist consultations."
    },
    {
      icon: <CheckCircle className="w-8 h-8 text-teal-600" />,
      title: "Digital Health Records",
      description: "Secure, centralized digital health records for all employees with easy access and comprehensive health tracking."
    },
    {
      icon: <Star className="w-8 h-8 text-yellow-600" />,
      title: "Premium Partnerships",
      description: "Exclusive partnerships with top hospitals, pharmacies, and diagnostic centers for the best healthcare rates."
    }
  ];
