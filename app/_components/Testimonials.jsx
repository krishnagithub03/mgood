          ...
          <div id="keen-slider" className="keen-slider gap-4">
            <div className="keen-slider__slide transition-opacity duration-500"> */}
              ...
              {/* <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                ...
                <p className="mt-4 text-gray-700">
                  Thanks Mgood for making us your partner. With this partnership
            ...
            <div className="hidden md:block keen-slider__slide transition-opacity duration-500">
              <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                ...
                <p className="mt-4 text-gray-700">
                  I have been practising physiotherapy from last 12 years, Mgood
...
//       },
//       "(min-width: 768px)": {
//         slidesPerView: 3, // 3 slides for larger screens (desktops)
//         spacing: 24,
//       },
//       "(min-width: 1024px)": {
//         slidesPerView: 4, // 4 slides for very large screens
//         spacing: 30,
//       },
//     },
//   });
...
//   return (
//     <section className="bg-white font-display py-12">
//       <div className="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
//         <h2 className="text-center text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl">
//           Trusted Reviews from Our Healthcare Partners
//         </h2>

//         <div className="mt-8">
//           <div ref={sliderRef} className="keen-slider">
//             {/* Testimonial 1 */}
//             <div className="keen-slider__slide p-6 bg-gray-50 rounded-lg shadow-md">
//               <div className="flex items-center gap-4">
//                 <img
//                   alt="Healthcare Partner"
//                   src="https://images.unsplash.com/photo-1595152772835-219674b2a8a6?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1180&q=80"
...
//                     ))}
//                   </div>
//                   <p className="mt-1 text-lg font-medium text-gray-900">AOC</p>
//                 </div>
//               </div>
//               <p className="mt-4 text-gray-700">
//                 Thanks Mgood for making us your partner. With this partnership
