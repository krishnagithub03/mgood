...
//   const initalOptions = 8;
//   const specialityList = [
//     { id: 1, name: "Dental", imgPath: "fas fa-tooth", path: "/search/Dental" },
//     { id: 2, name: "Ortho", imgPath: "fas fa-bone", path: "/search/Ortho" },
//     {
//       id: 3,
//       name: "Derma",
//       imgPath: "fas fa-spray-can",
//       path: "/search/Derma",
//     },
//     { id: 4, name: "Patho", imgPath: "fas fa-vial", path: "/search/Patho" },
//     { id: 5, name: "Pedo", imgPath: "fas fa-baby", path: "/search/Pedo" },
//     {
//       id: 6,
//       name: "Physiotherapy",
//       imgPath: "fas fa-running",
...
//       path: "/search/Dietician",
//     },
//     { id: 9, name: "Gyane", imgPath: "fas fa-female", path: "/search/Gyane" },
//     {
//       id: 10,
//       name: "Psychiatry",
//       imgPath: "fas fa-brain",
...
//       path: "/search/Cardio",
//     },
//     { id: 12, name: "Neuro", imgPath: "fas fa-brain", path: "/search/Neuro" },
//     {
//       id: 13,
//       name: "Urology",
//       imgPath: "fas fa-procedures",
...
//       path: "/search/Homeopathy",
//     },
//     { id: 21, name: "Eye", imgPath: "fas fa-eye", path: "/search/Eye" },
//     {
//       id: 22,
//       name: "ENT",
//       imgPath: "fas fa-head-side-cough",
...
//           .slice(0, showAll ? filteredSpecialityList.length : initalOptions)
//           .map((item) => (
//             <Link
//               key={item.id}
//               href={item.path}
...
const Hero = () => {
  ...
  return (
    <div className="mt-16 font-display font-bold flex flex-col items-center gap-4 px-5">
      ...
      {/* Full grid view remains unchanged */}
      {/* <div className="max-w-3xl grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 mt-5">
