...
const Event = () => {
  return (
    ...
    {/* <div className='text-center bg-white-100 py-2 text-sm font-medium'>
     ...
     <div className="group relative my-[1.5rem] mx-auto w-80 md:w-[400px] flex items-center justify-center rounded-full px-4 py-1.5 shadow-[inset_0_-8px_10px_#8fdfff1f] transition-shadow duration-500 ease-out hover:shadow-[inset_0_-5px_10px_#8fdfff3f]" onClick={() => window.location.href = '/camp'}>
      <span
        className={cn(
 ...
 duration-300 ease-in-out group-hover:translate-x-0.5"
    ...
    <div className="group relative my-[1.5rem] mx-auto w-80 md:w-[400px] flex items-center justify-center rounded-full px-4 py-1.5 shadow-[inset_0_-8px_10px_#8fdfff1f] transition-shadow duration-500 ease-out hover:shadow-[inset_0_-5px_10px_#8fdfff3f]" onClick={() => window.location.href = '/healthPackage'}>
      <span
        className={cn(
          "absolute inset-0 block h-auto w-auto animate-gradient rounded-[inherit] bg-gradient-to-r from-[#ffaa40]/50 via-[#9c40ff]/50 to-[#ffaa40]/50 bg-[length:300%_100%] p-[1px]",
        )}
